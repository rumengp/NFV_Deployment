...
class ReplayBuffer:  # for off-policy
    def __init__(self,
        ...
        self.masks = torch.empty((max_size, num_seqs, mask_dim), dtype=torch.float32, device=self.device)
    ...
    def update(self, items: Tuple[Tensor, ...]):
        self.add_item = items
        states, actions, rewards, undones, masks = items
